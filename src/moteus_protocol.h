    ...
    namespace moteus
    {
        ...
        struct Query
        {
                                       ...
                                       Resolution resolution)
            {
                ...
                static constexpr RegisterDefinition PROGMEM kRegisterDefinitions[] = {
                    ...
                    {
                        R::kCommandPositionMaxTorque,
                        1,
                        MP::kTorque,
                    },
                    {
                        R::kCommandStopPosition,
                        1,
                        MP::kPosition,
                    },
                    {
                    ...
                    {
                        R::kControlPositionError,
                        1,
                        MP::kPosition,
                    },
                    {
                        R::kControlVelocityError,
                        1,
                        MP::kVelocity,
                    },
                    {
                        R::kControlTorqueError,
                        1,
                        MP::kTorque,
                    },

                    {
                        R::kCommandStayWithinLowerBound,
                        2,
                        MP::kPosition,
                    },
                    // { R::kCommandStayWithinUpperBound, 1, MP::kPosition, },
                    {
                        R::kCommandStayWithinFeedforwardTorque,
                        1,
                        MP::kTorque,
                    },
                    {
                        R::kCommandStayWithinKpScale,
                        2,
                        MP::kPwm,
                    },
                    // { R::kCommandStayWithinKdScale, 1, MP::kPwm, },
                    {
                        R::kCommandStayWithinPositionMaxTorque,
                        1,
                        MP::kTorque,
                    },
                    {
                        R::kCommandStayWithinTimeout,
                        1,
                        MP::kTime,
                    },
        ...
        struct DiagnosticResponse
        {
            ...
            static Result Parse(MultiplexParser *parser)
            {
                ...
                if (action != Multiplex::kServerToClient)
                {
                    return result;
                }
